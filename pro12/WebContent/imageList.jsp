...
.lst_type li{overflow:hidden;clear:both;magin:10px 0 0;color:#2d2c2d;
...
.lst_type li span{color:blue; margin-left:330px; font-familay:'돋움',Dotum;font-size:14px}
...
<img src='image/duke.png' width='90' height='90'></a>
